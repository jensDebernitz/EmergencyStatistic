...
namespace ExcelTabellenAuswerung.Controls
{
    ...
    public class EditEmergencyData : ObservableObject
    {
        ...
        private string? _clinicalEvaluation = "";
    ...
    public partial class EditDataContentDialog : Window
    {
        ...
        public EditDataContentDialog(int id)
        {
            ...
            rmcData = new EditEmergencyData()
            {
                ...
                ClinicalEvaluation = _emergencyCase.Review1 != null ? _emergencyCase.Review1.IvenaRmc : ""
            };
        ...
        private void NumberValidationTextBox(object sender, TextCompositionEventArgs e)
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            using (var db = new LiteDatabase(Helpers.DataBase.DataBaseFileDocuments()))
            {
                ...
                {
                    string filePath = GetFolderPath(SpecialFolder.CommonApplicationData) + "/ExcelTabellenAuswertung/" + fileInfo[0].Filename;
                    try
                    {
        ...
        private void borderBewusstsein_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                editEmergencyData.ClinicalEvaluation = ReplaceAtIndex(editEmergencyData.ClinicalEvaluation, 0, changeString.ToCharArray()[0]);
            }
        }
        private void borderAtmung_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (editEmergencyData != null)
            {
                editEmergencyData.ClinicalEvaluation = ReplaceAtIndex(editEmergencyData.ClinicalEvaluation, 1, changeString.ToCharArray()[0]);
            }
        }
        private void borderKreislauf_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (editEmergencyData != null)
            {
                editEmergencyData.ClinicalEvaluation = ReplaceAtIndex(editEmergencyData.ClinicalEvaluation, 2, changeString.ToCharArray()[0]);
            }
        }
        private void borderVerletzung_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (editEmergencyData != null)
            {
                editEmergencyData.ClinicalEvaluation = ReplaceAtIndex(editEmergencyData.ClinicalEvaluation, 3, changeString.ToCharArray()[0]);
            }
        }
        private void borderNeurologie_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (editEmergencyData != null)
            {
                editEmergencyData.ClinicalEvaluation = ReplaceAtIndex(editEmergencyData.ClinicalEvaluation, 4, changeString.ToCharArray()[0]);
            }
        }
        private void borderSchmerz_MouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if (editEmergencyData != null)
            {
                editEmergencyData.ClinicalEvaluation = ReplaceAtIndex(editEmergencyData.ClinicalEvaluation, 5, changeString.ToCharArray()[0]);
            }
        }
